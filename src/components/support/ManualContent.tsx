            ...
            <div className={contentClasses}>
                ...
                {activeTab === 'intelligence' && canViewFinancials && (
                    <div className="animate-fade-in-up">
                        <SubSection title="Deep Analytics" icon={FiPieChart}>
                            <StepItem number="1" title="Configuring the Timeframe" link="/analytics">
                            ...
                            <StepItem number="2" title="Reading Financial Pulse" badge="AI POWERED">
                            ...
                            <StepItem number="3" title="Exporting the Dossier" badge="MODAL ACTION">
                    ...
                    <div className="animate-fade-in-up">
                        <SubSection title="Document Generation Engine" icon={FiPlus}>
                            <StepItem number="1" title="Initiating a Quote/Invoice" link="/new-invoice">
                                <p>Go to <strong>Create Document</strong>. Select the radio button for the document type first.</p>
                            </StepItem>
                            ...
                            <StepItem number="4" title="Finalizing PDF Layout">
                        ...
                        <SubSection title="Document Lifecycle Management" icon={FiFileText}>
                            <StepItem number="5" title="The High-Speed Edit" link="/invoices" badge="MODAL ACTION">
                            ...
                            <StepItem number="6" title="One-Click Conversion">
                                <p>Click the <strong>Convert</strong> (Sync) icon on any Quote to instantly generate the corresponding Tax Invoice.</p>
                            </StepItem>
                            <StepItem number="7" title="PDF Live Stream">
                                <p>The eye icon launches a real-time PDF buffer. These are generated on-the-fly with the latest company branding.</p>
                            </StepItem>
                        </SubSection>
                    </div>
                )}
                ...
                {activeTab === 'resource-hub' && (
                    <div className="animate-fade-in-up">
                        ...
                        <SubSection title="Secure Filestore" icon={FiDatabase}>
                            <StepItem number="3" title="The Document Vault" link="/documents">
                ...
                {activeTab === 'team-tasks' && (
                    <div className="animate-fade-in-up">
                        <SubSection title="Collaborative Workspace" icon={FiCheckSquare}>
                            ...
                            <StepItem number="2" title="Priority Memos" link="/memos">
                                <p>Post updates. Marking them <strong>High Priority</strong> broadcasts them to the dashboard of every active team member.</p>
                            </StepItem>
                            <StepItem number="3" title="Real-time Alerts" link="/notifications">
                                <p>Click notifications to jump directly to the relevant record (e.g., clicking a 'Paid' alert opens that invoice).</p>
                            </StepItem>
                        </SubSection>
                    </div>
                )}
                ...
                {activeTab === 'governance' && isAdmin && (
                    <div className="animate-fade-in-up">
                        ...
                        <SubSection title="Auditing" icon={FiShield}>
                ...
                {activeTab === 'configuration' && isAdmin && (
                    <div className="animate-fade-in-up">
                        <SubSection title="Global Settings" icon={FiSettings}>
                            ...
                            <StepItem number="3" title="Financial Engine" link="/settings/invoice">
                ...
                {activeTab === 'core-system' && isAdmin && (
                    <div className="animate-fade-in-up">
                        <SubSection title="Infrastructural Control" icon={FiDatabase}>
                            ...
                            <StepItem number="2" title="Internal Communications" link="/system/vitals">
                ...
                {activeTab === 'support-center' && (
                    <div className="animate-fade-in-up">
                        <SubSection title="Dev Assistance" icon={FiLifeBuoy}>
                            <StepItem number="1" title="The Ticketing Flow" link="/tickets">
                ...
                <div className="p-8 shrink-0 border-t border-gray-100 dark:border-midnight-800 bg-gray-50/30 dark:bg-midnight-900/30">
                    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.3em]">
                            Konsut Operating System &bull; Documentation Node v2.4.0
                        </p>
